...
public class Orbit extends JPanel
{
	...
	private final ImageIcon EARTH_ICON = new ImageIcon("../images/earth.png");
	
	private int orbitTheta;		// stores the angle of the orbiting object around the earth
	private int orbitTDelta;	// the amount the angle changes at each DELAY time interval
